...
export function TinyIcon({ className }: TinyIconProps) {
  return (
    <svg width="32" height="32" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <circle cx="14.47213595499958" cy="19.60845213036123" r="2.5" fill="#DC5E25"/>
      <circle cx="5.527864045000421" cy="16.702282018339787" r="2.5" fill="#7C9B13"/>
      <circle cx="5.5278640450004195" cy="7.297717981660216" r="2.5" fill="#E5D7BC"/>
      <circle cx="14.472135954999578" cy="4.391547869638771" r="2.5" fill="#2694af"/>
    </svg>
  );
}
